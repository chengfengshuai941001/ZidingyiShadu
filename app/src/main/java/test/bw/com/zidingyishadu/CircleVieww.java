package test.bw.com.zidingyishadu;
...
//                / 4, mTextPaint);
        canvas.drawText("我有个盆", mCircleXY, mCircleXY + textSize / 4, mTextPaint);
    }
...
//        Log.i("------------",String.valueOf(widthMeasureSpec));
//        Log.i("============",String.valueOf(heightMeasureSpec));
